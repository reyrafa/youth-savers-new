                        ...
                        <td class="body" width="100%" cellpadding="0" cellspacing="0"
                            ...
                            <table class="inner-body" align="center" width="570" cellpadding="0" cellspacing="0"
                                ...
                                <tr style="height: 90px;">
                                    <td style="text-align: center; font-weight:900; font-size:2em; ">YOUTH SAVERS CLUB
                                        APPLICATION</td>
                                </tr>
                                <tr>

                                    <td class="content-cell" style="text-align: justify;">

                                        <div style="font-weight:900">{{ __('Dear Youth,') }}</div>
                                        <br><br>
                                        <div>{!! $body['sentence_1'] !!}</div><br><br>
                                        <div>{{ $body['sentence_2'] }}</div>
                                        <span class="phone"><strong>{{ $body['phone_no'] }}</strong></span><br><br><br>
                                        <div class="contact1">
                                            <span class="name">
                                                Jenny P. Suaffield
                                        ...
                                        <div class="contact2">
                                            <span class="name">Oshin Kenny C. Macahilos</span><br> OIC - Youth
                                            Coordinator <br> 0935-289-5982
                                        </div><br>
                                        <div class="">
                                            Thank you.
                                        </div><br><br>
