            ...
            <div class="flex justify-center pb-20 pt-10">
                <div class=" w-5/6 h-full p-5 bg-gray-300 rounded-lg shadow-2xl">
                    ...
                    <div class="bg-cyan-500 rounded-lg text-justify p-4 mb-3">
                        <h1 class="text-2xl antialiased font-bold text-green-800 text-center mb-3">Youth Savers Club Online
                            Application</h1>
                    ...
                    <form action="{{ route('depositor.store') }}" method="POST" id="applicationForm"
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <select name="depositor[suffix]" id="" class="form-control mt-1 border-black">
                                    ...
                                    <option value="Sr" @if (old('depositor.suffix') == 'Sr') {{ 'selected' }} @endif>Sr
                                    </option>
                                    <option value="Jr" @if (old('depositor.suffix') == 'Jr') {{ 'selected' }} @endif>Jr
                                    </option>
                                    <option value="II" @if (old('depositor.suffix') == 'II') {{ 'selected' }} @endif>II
                                    </option>
                                    <option value="III" @if (old('depositor.suffix') == 'III') {{ 'selected' }} @endif>III
                                    </option>
                                    <option value="IV" @if (old('depositor.suffix') == 'IV') {{ 'selected' }} @endif>IV
                                    </option>
                                    <option value="V" @if (old('depositor.suffix') == 'V') {{ 'selected' }} @endif>V
                                    </option>
                                    <option value="VI" @if (old('depositor.suffix') == 'VI') {{ 'selected' }} @endif>VI
                                    </option>
                                    <option value="VII" @if (old('depositor.suffix') == 'VII') {{ 'selected' }} @endif>VII
                                    </option>
                                    <option value="VIII" @if (old('depositor.suffix') == 'VIII') {{ 'selected' }} @endif>
                                        VIII</option>
                                </select>
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="date" id="birth_date"
                                    name="depositor[birth_date]" required value="{{ old('depositor.birth_date') }}"
                                    min="{{ now()->subYears(17)->format('Y-m-d') }}"
                                    max="{{ now()->subYears(7)->format('Y-m-d') }}" />
                                <span style="color: red; font-size: 10px" id="birth_error" class="ml-2 mt-2 hidden">Opps,
                                    Age should be between 7 - 17 years old
                                </span>
                            </div>
                            <div class="col-lg-2 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="number"
                                    ...
                                    value="{{ old('depositor.contact_number') }}"
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <select name="depositor[gender]" id="" class="form-control mt-1 border-black"
                                    ...
                                    <option value="Male" @if (old('gender') == 'depositor.Male') {{ 'selected' }} @endif>
                                        Male</option>
                                    <option value="Female" @if (old('gender') == 'depositor.Female') {{ 'selected' }} @endif>
                                        Female</option>
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <select name="depositor[branch_loc_id]" id="branch_loc_id"
                                    class="form-control mt-1 border-black" required>
                                    <option value="" disabled="disabled" selected="true">--Select Location--
                                    </option>
                                    @foreach ($locations as $location)
                                        @if ($location->id != 7)
                                            <option value={{ $location->id }}
                                                {{ old('depositor.branch_loc_id') == $location->id ? 'selected' : '' }}>
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <select name="depositor[branch_id]" id="branch_id" class="form-control mt-1 border-black"
                                    required>
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    ...
                                    value="{{ old('depositor.home_address') }}" />
                            ...
                            <div class="col-lg-12 mb-4">
                                <span class="text-xl text-green-800 block font-bold p-2 rounded-lg bg-cyan-500">Guardian
                                    Information</span>
                            </div>
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <select name="guardian[g_suffix]" id="" class="form-control mt-1 border-black">
                                    <option value="">suffix</option>
                                    <option value="Sr" @if (old('guardian.g_suffix') == 'Sr') {{ 'selected' }} @endif>
                                        Sr</option>
                                    <option value="Jr" @if (old('guardian.g_suffix') == 'Jr') {{ 'selected' }} @endif>
                                        Jr</option>
                                    <option value="II" @if (old('guardian.g_suffix') == 'II') {{ 'selected' }} @endif>
                                        II</option>
                                    <option value="III" @if (old('guardian.g_suffix') == 'III') {{ 'selected' }} @endif>
                                        III</option>
                                    <option value="IV" @if (old('guardian.g_suffix') == 'IV') {{ 'selected' }} @endif>
                                        IV</option>
                                    <option value="V" @if (old('guardian.g_suffix') == 'V') {{ 'selected' }} @endif>
                                        V</option>
                                    <option value="VI" @if (old('guardian.g_suffix') == 'VI') {{ 'selected' }} @endif>
                                        VI</option>
                                    <option value="VII" @if (old('guardian.g_suffix') == 'VII') {{ 'selected' }} @endif>
                                        VII</option>
                                    <option value="VIII" @if (old('guardian.g_suffix') == 'VIII') {{ 'selected' }} @endif>
                                        VIII</option>
                                </select>
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="date"
                                    name="guardian[g_birth_date]" required value="{{ old('guardian.g_birth_date') }}" />
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <select name="guardian[g_gender]" id="" class="form-control mt-1 border-black"
                                    required>
                                    <option value="" disabled="disabled" selected="true">-- Sex --</option>
                                    <option value="Male" @if (old('guardian.g_gender') == 'Male') {{ 'selected' }} @endif>
                                        Male</option>
                                    <option value="Female" @if (old('guardian.g_gender') == 'Female') {{ 'selected' }} @endif>
                                        Female</option>
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <select name="guardian[g_civil_status]" id="g_civil_status"
                                    ...
                                    <option value="Single"
                                        {{ old('guardian.g_civil_status') == 'Single' ? 'selected' : '' }}>Single</option>
                                    <option value="Married"
                                        {{ old('guardian.g_civil_status') == 'Married' ? 'selected' : '' }}>Married
                                    </option>
                                    <option value="Separated"
                                        {{ old('guardian.g_civil_status') == 'Separated' ? 'selected' : '' }}>Separated
                                    </option>
                                    <option value="Widowed"
                                        {{ old('guardian.g_civil_status') == 'Widowed' ? 'selected' : '' }}>Widowed
                                    </option>
                                </select>
                            ...
                            <div class="col-lg-2 mb-4">
                                ...
                                <select name="guardian[g_member_or_not]" id=""
                                    ...
                                    <option value="Yes"
                                        {{ old('guardian.g_member_or_not') == 'Yes' ? 'selected' : '' }}>Yes</option>
                                    <option value="No"
                                        {{ old('guardian.g_member_or_not') == 'No' ? 'selected' : '' }}>No</option>
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    ...
                                    value="{{ old('guardian.g_depositor_relation') }}" />
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    ...
                                    value="{{ old('guardian.g_home_address') }}" />
                            ...
                            <div class="col-lg-6 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    ...
                                    value="{{ old('guardian.g_present_address') }}" />
                            ...
                            <div class="col-lg-3 mb-4">
                                ...
                                <input class="mt-1 rounded-lg form-control border-black" type="number"
                                    ...
                                    value="{{ old('guardian.g_contact_num') }}" />

                            </div>
                            <div class="col-lg-3 mb-4">
                                <x-label for="g_email_add">Email (<span class="text-blue-500">Not Required</span>)
                                </x-label>
                                <input class="mt-1 rounded-lg form-control border-black" type="email"
                                    ...
                                    value="{{ old('guardian.g_email_add') }}" />

                            </div>

                            {{-- referral information --}}
                            <div class="col-lg-12 mb-4">
                                <span class="text-xl text-green-800 block font-bold p-2 rounded-lg bg-cyan-500">Referral
                                    Information ( <span class="text-blue-700">Optional</span> )</span>
                            </div>
                            <div class="col-lg-3 mb-4">
                                <x-label for="r_fname" value="{{ __('Firstname') }}" />
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    name="referral[r_fname]" placeholder="Enter Firstname"
                                    value="{{ old('referral.r_fname') }}" />

                            </div>
                            <div class="col-lg-3 mb-4">
                                <x-label for="r_mname" value="{{ __('Middlename') }}" />
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    name="referral[r_mname]" placeholder="Enter Middlename"
                                    value="{{ old('referral.r_mname') }}" />

                            </div>
                            <div class="col-lg-3 mb-4">
                                <x-label for="r_lname" value="{{ __('Lastname') }}" />
                                <input class="mt-1 rounded-lg form-control border-black" type="text"
                                    name="referral[r_lname]" placeholder="Enter Lastname"
                                    value="{{ old('referral.r_lname') }}" />

                            </div>
                            <div class="col-lg-3 mb-4">
                                <x-label-required for="r_branch_id" value="{{ __('Branch') }}" />
                                <select name="referral[r_branch_id]" id="r_branch_id"
                                    class="form-control mt-1 border-black">
                                    <option value="" disabled="disabled" selected="true">--Select Location--
                                    </option>
                                    @foreach ($branchs as $branch)
                                        <option value={{ $branch->id }}
                                            {{ old('referral.r_branch_id') == $branch->id ? 'selected' : '' }}>
                            ...
                            {{-- scanned documents --}}
                            <div class="col-lg-12 mb-4">
                                <span class="text-xl text-green-800 block font-bold p-2 rounded-lg bg-cyan-500">Scanned
                                    Documents</span>
                            </div>
                            <div class="col-lg-12 mb-4">
                                <x-label-required for="signature_img">Scanned Signature over Printed name <span
                                        class="text-blue-500 ml-2">(Accepts .png, .jpg, .jpeg)</span></x-label-required>
                                <input type="file" accept="image/jpeg, image/png, image/jpg" class="mt-1"
                                    id="signature_img" name="uploaded_file[signature_img]" required />
                            </div>
                            <div class="col-lg-12 mb-4">
                                <x-label-required for="identification_img">Scanned Valid ID <span
                                        class="text-blue-500 ml-2">(Accepts .png, .jpg, .jpeg)</span></x-label-required>

                                <input type="file" class="mt-1" id="identification_img"
                                    name="uploaded_file[identification_img]"
                                    @if ($errors->any()) data-initial-value="{{ old('uploaded_file.identification_img') }}" @endif
                                    required>
                            </div>
                            <div class="col-lg-12 mb-4">
                                <x-label-required for="birth_cert_img">Scanned Birth Certificate<span
                                        class="text-blue-500 ml-2">(Accepts .png, .jpg, .jpeg)</span></x-label-required>
                                <input type="file" class="mt-1" id="birth_cert_img"
                                    name="uploaded_file[birth_cert_img]"
                                    @if ($errors->any()) data-initial-value="{{ old('uploaded_file.birth_cert_img') }}" @endif
                                    required>
                            </div>

                            {{-- Online Transaction --}}
                            <div class="col-lg-12 mb-3">
                                <span class="text-xl text-green-800 block font-bold p-2 rounded-lg bg-cyan-500">Payment
                                    Screenshot</span>
                            </div>
                            <div class="col-lg-12 mb-2">
                                <h2 class="text-green-600 text-lg font-semibold">Gcash Information : <span
                                        class="text-blue-800">09*********</span></h2>
                                <h2 class="text-green-600 text-lg font-semibold">Bank Information : <span
                                        class="text-blue-800">854 **** ***</span></h2>
                                <p class="mt-3 mb-3">Note : PHP 150.00 - Membership fee</p>
                            </div>
                            <div class="col-lg-12 mb-4">
                                <x-label-required for="receipt_img">Scanned Reciept <span
                                        class="text-blue-500 ml-2">(Accepts .png, .jpg, .jpeg)</span></x-label-required>
                                <input type="file" class="mt-1" id="receipt_img" name="uploaded_file[receipt_img]"
                                    value="{{ old('uploaded_file.receipt_img') }}" required>
                            </div>
                            <div class="d-flex justify-content-end">
                                <button class="bg-green-600 hover:bg-green-800 rounded-full py-2 px-5 text-white"
                                    type="submit" id="submit_application">
                                    Submit Application
                                </button>
                            </div>
                        </div>
            ...
            <script>
                ...
                const pond = FilePond.create(signature_img, {
                    ...
                    onaddfile: function(error, file) {
                        if (!error) {
                            if (file.fileType !== 'image/png' && file.fileType !== 'image/jpeg' && file.fileType !==
                                'image/jpg') {
                ...
                /*    const hasError = document.querySelector('.validation_error')


                    const inputElement = document.getElementById('signature_img');

                    // Initialize FilePond with the input element
                    const filePondInstance = FilePond.create(inputElement);

                    // Get the previously uploaded file value from the old input
                    const previousFileValue = '{{ old('uploaded_file.signature_img') }}';
                    console.log(previousFileValue);
                    console.log(filePondInstance);

                    if (hasError) {

                        filePondInstance.setOptions({
                            files: [{
                                source: '/storage/uploads/signature/' + previousFileValue,
                                options: {
                                    type: 'local',
                                }
                            }]
                        ...
                        pond1.setOptions({
                            files: [{
                                source: '/storage/uploads/valid_id/' + document.querySelector("#identification_img")
                                    .value,
                                options: {
                                    type: 'local',
                                }
                        ...
                        pond2.setOptions({
                            files: [{
                                source: '/storage/uploads/bcertificate/' + document.querySelector("#birth_cert_img")
                                    .value,
                                options: {
                                    type: 'local',
                                }
                        ...
                        pond3.setOptions({
                            files: [{
                                source: '/storage/uploads/receipt/' + document.querySelector("#receipt_img").value,
                                options: {
                                    type: 'local',
                                }
                            }]
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                ...
                                $.each(options, function(index, option) {
                                    ...
                                    $('#branch_id').append('<option value="' + option.id +
